      ...
      {({ open }) => (
        <>
          <div className="relative">
            <Listbox.Button className="relative flex items-center justify-between w-auto min-w-[120px] cursor-default rounded-full bg-ctp-matle/40 backdrop-blur-sm p-2 px-3 text-left text-ctp-text shadow-sm ring-1 ring-inset ring-ctp-overlay0/20 hover:bg-ctp-mantle/60 transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-ctp-lavender">
              <span className="pointer-events-none flex items-center">
                <PaletteSVG />
              </span>
              <span
                className="animate-colorchange bg-gradient-to-r from-ctp-teal via-ctp-lavender bg-clip-text
                  text-sm font-semibold text-transparent nf mr-4"
              >
